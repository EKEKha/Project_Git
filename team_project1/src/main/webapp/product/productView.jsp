...
<div class="breadcrumbs">
			<div class="container">
				<div class="row">
					<div class="col">
						<p ><span><a href="productListView.po?prod_kind=racket">RACKET</a></span> / 
						<span><a href="productListView.po?prod_kind=acc">ACC</a></span>/
						<span>
						<a href="searchPriceForm.po?line=1&prod_kind=${param.prod_kind}"> <svg
				  ...
				  <path
						...
						<span>
							<a href="searchPriceForm.po?line=0&prod_kind=${param.prod_kind}">
