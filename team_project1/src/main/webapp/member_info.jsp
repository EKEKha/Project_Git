	...
	<div class="container">
		<div class="row">
			...
			<div class="login-wrapper">
					...
					<form method="post" name="f" action="memberUpdate.me"  id="login-form">
					
						<input type="hidden" name="mem_id" value="${member.mem_id }">
						이름<input type="text" name="mem_name" id="mem_name" value="${member.mem_name }" readonly placeholder="이름" > 
						이메일<input type="text" name="mem_email" id="mem_email" value="${member.mem_email }" readonly placeholder="이메일입력  ex) tss000@naver.com" > 
						전화번호<input type="text"name="mem_call" id="mem_call" value="${member.mem_call }" readonly placeholder="전화번호" > 
						우편번호<input type="text"name="mem_postcode" id="mem_postcode" value=${member.mem_postcode } style="width:150px;" readonly placeholder="우편번호"> &nbsp;
						<input type="button" name="u_idck" id="u_idck"  style="width:90px;" value="찾기" 
							onclick="sample6_execDaumPostcode()"> <br>
						주소<input type="text" name="mem_address1" id="mem_address1" value="${member.mem_address1 }" readonly placeholder="주소" >
						상세주소<input type="text" name="mem_address2" id="mem_address2" value="${member.mem_address2 }" readonly placeholder="상세주소" >
						참고<input type="text" name="mem_address3" id="mem_address3" value="${member.mem_address3 }" readonly placeholder="참고항목">
						포인트<input type="text" name="mem_point" id="mem_point" value="${member.mem_point }" readonly placeholder="포인트">
						...
						<input type="submit" value="회원정보 수정" style="width:150px;" />
