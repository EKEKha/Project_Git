		...
		<div class="row">
			...
			<div class="login-wrapper">
					...
					<form method="post" name="f" action="memberJoinAction.me"  id="login-form">
						...
						<input type="text" name="mem_id" id="mem_id" style="width:150px;" placeholder="아이디" >&nbsp;
						<input type="button" name="u_idck" id="u_idck"  style="width:90px;" value="중복체크" 
						...
						<input type="text" name="mem_email" id="mem_email" placeholder="이메일입력  ex) tss000@naver.com" > 
						<input type="text"name="mem_call" id="mem_call"  placeholder="전화번호" > 
						<input type="text"name="mem_postcode" id="mem_postcode" style="width:150px;" placeholder="우편번호"> &nbsp;
						...
						<input type="submit" value="가입하기" style="width:150px;" onclick="check(); return false;">
						<input type="button" value="다시작성" style="width:150px;"  onclick="reWrite();">
