...
<body onload="init()"
	style="background-color: #ffffff; text-align: center; color: #000000;">
	<section>
		<div style="padding: 10px;">
			<div
				style="border: 3px solid gold; padding-top: 50px; padding-bottom: 50px;">
...
if (chk_id != null && !chk_id.trim().equals("")) {
	...
	if (useable.equals("NO")) {
		...
		out.println("<a style=\" background-color : #ffffff; color : gold;\" href ='javascript:useId(\"" + chk_id
		+ "\")'>사용하기</a></p>");
	}
}
%>
